...
- The library pin moves from cost-core 2.0.0 to 2.4.0. No number moves:
  2.1.0 to 2.4.0 add subpackages (public SAR data, analysis of alternatives,
  ...
  `cost_core version` row of the Analyst_Summary sheet, which reads 2.4.0. The pin went through 2.1.0 on
