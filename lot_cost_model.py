...
# those, and 2.1.0 added subpackages this window doesn't use. A 3.x is free to
# move any of them, so refuse to start rather than fail somewhere further in
# with a KeyError.
